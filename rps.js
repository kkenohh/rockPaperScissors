  ...
  switch (choice) {
    case 0:
      computerSelect.innerHTML =
        '<i class="icon fa-regular fa-hand-back-fist fa-8x"></i>';
      break;
    case 1:
      computerSelect.innerHTML =
        '<i class="icon fa-regular fa-hand fa-8x"></i>';
      break;
    case 2:
      computerSelect.innerHTML =
        '<i class="icon fa-regular fa-hand-scissors fa-8x"></i>';
      break;
  }
  return choice;
}
...
function resetGame() {
  mainText.innerHTML =
    'Rock, Paper, Scissors. First to 5. <span class="tertiary">Ready?</span>';
  playerSelect.innerHTML = "";
  computerSelect.innerHTML = "";
